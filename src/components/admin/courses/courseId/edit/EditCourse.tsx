...
import { updateCourse } from "@/app/admin/action.admin"

export const EditCourse = ({course}: {course: any}) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    await updateCourse({courseId: courseData.id, name, description, image, state});
  }

  return <div className="max-w-[800px] mx-auto">
      <h2 className="text-2xl font-bold border-b border-gray-800 py-3 mb-5 w-fit">Edit Course</h2>
      <form onSubmit={handleSubmit} className="bg-[#1C1917] border border-gray-800 p-6 rounded-lg mb-10">
        <div className="mb-4">
          ...
          <Input
            ...
            id="image"
            name="image"
            defaultValue={courseData.image ? courseData.image : "No image"}
        ...
        <div className="mb-6">
          ...
          <Select name="state" defaultValue={courseData.state}>
